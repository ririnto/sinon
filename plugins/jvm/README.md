...
- `jvm-runtime-diagnostics`: runtime incident triage with stack traces, thread dumps, `jcmd`, JFR, and memory-pressure evidence; `jstack` and `jmap` remain legacy or narrower-purpose paths.
