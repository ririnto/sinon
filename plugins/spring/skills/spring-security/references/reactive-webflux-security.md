...
Use the JWT resource-server call shown in the dedicated API chain above.
Authority extraction properties (`authorities-claim-name`, `authorities-claim-expressions`, and `authority-prefix`) apply to reactive applications the same as servlet.
