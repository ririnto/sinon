...
The documented Spring Security 7.1 baseline resolves OpenSAML 5.2.2 artifacts.
Check the project's managed dependency tree before adding the Shibboleth repository or an internal mirror for unresolved artifacts.
