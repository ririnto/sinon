...
The documented 4.0.x line supports reactive event handling alongside the imperative modeling path.
...
The documented 4.0.x line also provides synchronous boolean `sendEvent(...)` methods.
