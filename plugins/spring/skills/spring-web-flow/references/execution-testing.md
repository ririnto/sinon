...
final class BookingServiceStub implements BookingService {
    ...
    /**
     * Returns the booking unchanged, or throws when failure mode was armed for the test.
     */
    @Override
...
class BookingFlowHarness extends AbstractXmlFlowExecutionTests {
    ...
    /**
     * Locates the booking flow definition XML that this harness executes.
     */
    @Override
    ...
    /**
     * Registers the stubbed services and subflows the flow builder needs.
     */
    @Override
