...
```java
/**
 * Converts token-endpoint requests with the {@code custom_code} grant type into a grant-specific authentication token.
 */
public final class CustomCodeGrantAuthenticationConverter implements AuthenticationConverter {
    /**
     * Returns the grant authentication, or {@code null} when the grant type parameter is not the custom one.
     */
    @Override
...
@Component
/**
 * Validates the custom grant and issues an access token through the configured token generator.
 */
public final class CustomCodeGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    /**
     * Authenticates the custom grant, persists the resulting authorization, and returns the access-token authentication.
     */
    @Override
    ...
    /**
     * Restricts this provider to {@link CustomCodeGrantAuthenticationToken} instances.
     */
    @Override
