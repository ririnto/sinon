...
```java
/**
 * Handles one message payload received through the Redis channel.
 */
...
Verified against the Spring Boot 4.1 release notes and the Spring Boot `4.1.1` source tag.
...
- [spring-boot `v4.1.1` source tag](https://github.com/spring-projects/spring-boot/tree/v4.1.1)
