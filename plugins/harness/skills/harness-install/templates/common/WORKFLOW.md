...
Give agents a single page they can read to know *how things get done here* — branch naming, commit conventions, review gates, deployment promotion, and runbook entry points. This document is the procedural counterpart of `AGENTS.md` (the harness contract) and `ARCHITECTURE.md` (the system shape).
