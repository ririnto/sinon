...
Review changes in this target repository against the installed harness. Findings come first; summaries are secondary.
...
5. Run or require the stack-specific harness validation command.
