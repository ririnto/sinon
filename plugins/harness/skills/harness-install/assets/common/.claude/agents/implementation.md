...
1. Inspect supplied context first, then discover the complete affected set and the minimal additional context needed for the assigned scope.
2. Confirm the affected files and acceptance criteria before editing.
