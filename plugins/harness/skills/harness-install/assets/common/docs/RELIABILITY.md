...
`RELIABILITY.md` captures the reliability contract.
It records targeted SLOs, accepted failure modes and mitigations, recovery procedures, and observability entry points.
