...
Give agents a single page that defines repository workflow: branch naming, commit conventions, review gates, deployment promotion, and runbook entry points. This document is the procedural counterpart of `CLAUDE.md` (the repository contract) and `ARCHITECTURE.md` (the system shape).
