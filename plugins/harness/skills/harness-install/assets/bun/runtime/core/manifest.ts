...
function categoryObjectFromManifest(
...
function isEnabledFromManifest(
  rawManifest: Record<string, unknown>,
  category: string,
): boolean {
...
function stringValueFromManifest(
  rawManifest: Record<string, unknown>,
  category: string,
): string {
  return typeof rawManifest[category] === "string"
    ? (rawManifest[category] as string)
    : "";
}

function stringArrayFromManifest(
  rawManifest: Record<string, unknown>,
  category: string,
): readonly string[] {
