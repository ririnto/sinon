 ...
 */
export const mutableCollectionRule = (
	ctx: RuleContext,
): HarnessCheckRule => ({
	...
	validate(_root: string, manifest: HarnessManifest): readonly Finding[] {
		return ctx.stackSources(manifest, "mutableCollection", "typescript").flatMap((file) => {
			...
			try {
				...
				return [
					{
						severity: ctx.severityOf(manifest, "mutableCollection"),
						category: "mutableCollection",
