...
class UnstructuredLoggingKtlintRule :
    ...
    companion object {
        private val forbiddenApis: Set<String> = setOf("println")
        private val allowedApis: Set<String> = emptySet()
    }
                ...
                ktFile.accept(
                    object : KtTreeVisitorVoid() {
                        override fun visitCallExpression(expression: KtCallExpression) {
                            ...
                            when {
                                callName in allowedApis || qualifiedCall in allowedApis -> {
                                    return
                                }
                        ...
                        private fun qualifiedCallName(
                            ...
                            (expression.parent as? KtDotQualifiedExpression)
                                ...
                                ?.let { qualified ->
                                    (expressionParts(qualified.receiverExpression) + callName).joinToString(
                                        "."
                                    )
                                }
                                ?: callName
