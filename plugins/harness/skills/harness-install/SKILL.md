...
4. Identify the active CI host.
   - Use the target repository policy to select GitHub, GitLab, both, or neither.
...
- `skills/harness-install/assets/common/skills/problem-analysis/SKILL.md`: problem-analysis skill.
...
- Keep runtime services, task queues, workspace management, and team generation in project systems.
