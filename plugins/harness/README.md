...
Installed targets also receive `autonomous-execution` and `problem-analysis` under `.claude/skills/`, mirrored at `.agents/skills/` for hosts without a Claude-style skill loader.
