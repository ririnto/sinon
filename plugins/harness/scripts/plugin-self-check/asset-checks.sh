...
assert_common_assets_structure() {
    ...
    require_text "$common_assets_root/WORKFLOW.github.md" "docs/templates/github/tasks"
    require_text "$common_assets_root/WORKFLOW.github.md" "docs/templates/github/change-description.md"
    reject_file_contains "$common_assets_root/WORKFLOW.github.md" "gh issue"
    reject_file_contains "$common_assets_root/WORKFLOW.github.md" "gh pr"
    reject_file_contains "$common_assets_root/WORKFLOW.github.md" "Closes #"
    require_text "$common_assets_root/WORKFLOW.gitlab.md" "docs/templates/gitlab/tasks"
    require_text "$common_assets_root/WORKFLOW.gitlab.md" "docs/templates/gitlab/change-description.md"
    reject_file_contains "$common_assets_root/WORKFLOW.gitlab.md" "glab api"
    reject_file_contains "$common_assets_root/WORKFLOW.gitlab.md" "Closes #"
