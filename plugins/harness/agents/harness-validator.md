...
description: Verify installed harness assets, manifests, executable scripts, hooks, CI commands, and stack validation paths. Use this agent after harness install, refresh, evolution, or packaging changes require mechanical verification.
model: sonnet
color: green
---
