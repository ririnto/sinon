...
description: |-
  ...
  <example>
  Context: A local change set updates `docs/harness/README.md` to add a new validation step but the corresponding validator skill and CI snippet were not updated.
