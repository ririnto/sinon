...
- Apply Conventional Commits rules consistently: type(optional-scope): subject, blank line, body, optional footers for breaking changes or related commit references.
...
7. Add footers if applicable: related commit references (`Refs: a1b2c3d`), breaking changes (`BREAKING CHANGE: ...`), co-authors.
