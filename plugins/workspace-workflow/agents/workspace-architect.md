...
| integrateed or shared branch would require rewritten history | Prefer a non-rewriting path unless collaborators explicitly coordinate | `workspace-workflow:git-merge-strategies` |
