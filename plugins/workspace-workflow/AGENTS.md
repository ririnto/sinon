...
`skills/pr-mr-convention/` owns host-neutral publication guidance and host references.
Agents draft or route work.
They do not publish.

## Publication Host Selection
...
If GitHub and GitLab remain plausible, ask for a choice.
...
GitHub and GitLab command syntax belongs in their separate references.
