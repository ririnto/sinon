...
description: >-
  ...
  Use this skill when the user needs to check working tree status, manage stashed changes, verify branch sync state, establish hygiene invariants, or prepare a tree for safe integration handoff.
---
...
- You need to ensure a branch is push-able before attempting integration handoff.
