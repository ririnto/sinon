...
description: >-
  ...
  user: "Reproduce the reported bug, fix it, and show that the flow now works"
...
5. Prepare review-ready evidence for local review and integration handoff.
...
8. Prepare the review package with the change summary and evidence for local review and integration handoff.
...
4. The review-ready handoff status
