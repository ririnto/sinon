...
| .github/workflows/harness-checks.yml | assets/github-actions.yml.template | create | ci.provider is github-actions |
| .githooks/pre-push | assets/git-hooks.md.template | create | hooks.enabled is true |
```
