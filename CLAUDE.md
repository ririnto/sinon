...
- `CLAUDE.md` is the canonical root rules document.
  - `AGENTS.md` is a symlink to it.
  - Treat them as one document, not parallel copies.
...
Any coding agent runtime that loads `AGENTS.md` or `CLAUDE.md` MUST treat this document as the primary repository contract.
