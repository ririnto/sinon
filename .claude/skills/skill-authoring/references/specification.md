...
> This document is a faithful mirror of the canonical specification, adapted for offline use. Load it when you need an authoritative answer about a frontmatter field, directory rule, or progressive-disclosure guideline.
...
The agent loads the entire file once it decides to activate a skill. Consider splitting longer `SKILL.md` content into referenced files.
...
Use the reference library at https://github.com/agentskills/agentskills/tree/main/skills-ref to validate a skill:

```bash
skills-ref validate ./my-skill
```

This checks that the `SKILL.md` frontmatter is valid and follows all naming conventions. This skill also bundles `scripts/validate_skill.sh` for the same purpose.
